...
export const FAQSection = forwardRef<HTMLElement>(function FAQSection(_, ref) {
  ...
  const faqs = [
    { q: 'Isso dá Ban na minha conta?', a: 'Não. O sistema Overise possui um Escudo Anti-Ban que isola a conexão. Você joga com 100% de segurança sem risco para a sua conta principal.' },
