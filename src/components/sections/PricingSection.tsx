...
const PLANS: Plan[] = [
  {
    ...
    price: "9",
    cents: ",97",
    tagline: "Pacote com 1.000 jogos",
    features: [
      "1.000 jogos selecionados",
      "Download pela própria Steam",
      "Modo história liberado",
      "Suporte no WhatsApp",
    ],
    cta: "Escolher o Básico",
    value: 9.97,
  },
  {
    id: "avancado",
  ...
  return (
    <section id="planos" className="pricing-section">
            ...
            >
              ...
              <ul className="plan-features">
                {plan.features.map((feat, idx) => (
                  <li key={idx} className="plan-feat">
      ...
      <style>{`
        ...
        .pricing-header h2 {
          font-size: clamp(28px, 5vw, 46px); font-weight: 950; color: #fff;
          letter-spacing: -1.5px; line-height: 1.08; margin: 0 0 12px;
        }
        ...
        .pricing-timer .pt-clock {
          font-family: 'Sora', monospace; font-weight: 900; color: #fff; letter-spacing: 2px;
          background: rgba(0,0,0,.6); border: 1px solid rgba(0,255,65,.3); padding: 4px 12px; border-radius: 8px;
        }
        ...
        .plan-card {
          ...
          padding: 38px 28px 30px; display: flex; flex-direction: column; align-items: center;
        ...
        .plan-featured {
          ...
          box-shadow: 0 0 70px rgba(0,255,65,.10), inset 0 1px 0 rgba(0,255,65,.14);
        }
        @media (min-width: 961px) { .plan-featured { transform: scale(1.04); } .plan-featured:hover { transform: scale(1.04) translateY(-4px); } }

        .plan-badge {
          position: absolute; top: -13px; left: 50%; transform: translateX(-50%);
          padding: 6px 16px; border-radius: 999px; font-size: 10px; font-weight: 900;
        ...
        .plan-tax { font-size: 11px; font-weight: 900; color: var(--neon); letter-spacing: 2px; text-transform: uppercase; margin-top: 4px; margin-bottom: 5px; }
        ...
        @media (max-width: 960px) {
          .pricing-grid { grid-template-columns: 1fr; max-width: 420px; gap: 32px; }
        }
